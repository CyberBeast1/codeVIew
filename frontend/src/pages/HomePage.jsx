      ...
      <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          <SignInButton mode="modal">
            <button className="group px-6 py-3 bg-gradient-to-r from-accent to-primary rounded-xl text-white font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="stats stats-vertical lg:stats-horizontal bg-base-100 shadow-lg">
              ...
              <div className="stat">
                ...
                <div className="stat-title">Downtime</div>
              </div>
            </div>
          </div>
          ...
          <img
            ...
            className="w-full h-auto rounded-3xl shadow-2xl border-4 border-base-100 scale-125 hover:scale-115 transition-transform duration-500"
          />
        </div>
      </div>
      {/* FEATURES SECTION */}
